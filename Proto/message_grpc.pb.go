...
type MessageServiceClient interface {
	...
	Intercambio2(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *messageServiceClient) Intercambio2(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/grpc.MessageService/Intercambio2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessageServiceServer interface {
	...
	Intercambio2(context.Context, *Message) (*Message, error)
...
func (UnimplementedMessageServiceServer) Intercambio2(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Intercambio2 not implemented")
}
...
func _MessageService_Intercambio2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageServiceServer).Intercambio2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.MessageService/Intercambio2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).Intercambio2(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MessageService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Intercambio2",
			Handler:    _MessageService_Intercambio2_Handler,
		},
	},
